                        ...
                        <div class="left-panel">
                            ...
                            <div class="control-panel">
                                ...
                                <div>
                                    ...
                                    <input id="scode${n}" class="condition" type="text" placeholder="ex:2330">
                                </div>
                                <div>
                                    ...
                                    <div style="margin-bottom:10px">
                                        <input type="text "id="qdate${n}" class="condition" type="text" value="1mo" readonly>
                                    </div>
                                  
                                </div>          
                                <div>
                                    <label class="lb">模糊化係數(例如:30,表示以30為一格,減少小波動):</label>
                                    <input id="mosiac${n}" class="condition" type="text" placeholder="ex:30">
                                </div>
                            </div>
                        </div>
